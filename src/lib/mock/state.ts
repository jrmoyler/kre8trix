...
function defaultState(): MockState {
  return {
    ...
    notifications: [
      { id: 'ntf_1', title: 'Payout delayed', body: 'YouTube payout delayed 5 days — expected Oct 22.', time: '2h ago', read: false, accentColor: 'rgb(var(--color-gold))' },
      { id: 'ntf_2', title: 'CCS score updated', body: 'Your Creator Credit Score rose to 612 (+17).', time: '1d ago', read: false, accentColor: 'rgb(var(--color-electric))' },
      { id: 'ntf_3', title: 'Advance repayment', body: '$318 auto-deducted toward advance KRA-2847.', time: '2d ago', read: false, accentColor: 'rgb(var(--color-acid))' },
