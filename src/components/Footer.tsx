export default function Footer() {
  return (
    <footer className="border-t border-[rgba(255,255,255,0.08)] bg-deep px-6 py-4 mt-auto">
      <div className="flex items-center justify-between max-w-[1400px] mx-auto">
        ...
        <span className="font-mono text-[12px] text-[rgba(255,255,255,0.2)] tracking-[0.04em]">
