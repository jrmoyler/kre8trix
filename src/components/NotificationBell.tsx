      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-12 w-[360px] bg-panel border border-[rgba(255,255,255,0.1)] rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.5)] z-[70]"
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-[rgba(255,255,255,0.08)]">
              <span className="font-body text-[14px] font-semibold text-white">Notifications</span>
              {unreadCount > 0 && (
                <button
                  onClick={markAllRead}
            ...
            <div className="max-h-[320px] overflow-y-auto">
              {!notifications ? (
                <div className="px-5 py-8 text-center font-mono text-[12px] text-[rgba(255,255,255,0.42)]">
                  Loading…
                </div>
